...
`)
	...
	assertContains(t, body, "anthropics/claude-code-action@v1.0.202", "Claude Code workflow body")
	...
	assertContains(t, body, "--model ${{ inputs.model || 'claude-opus-5' }}", "Claude Code workflow body")
...
`)
	...
	assertContains(t, body, "inference-gateway/infer-action@v0.49.2", "Infer workflow body")
