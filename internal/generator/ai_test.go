...
`)
	...
	assertContains(t, body, "anthropics/claude-code-action@v1.0.173", "Claude Code workflow body")
...
`)
	...
	assertContains(t, body, "github-token: ${{ secrets.GITHUB_TOKEN }}", "Infer workflow body")
