...
`)
	...
	assertContains(t, body, "anthropics/claude-code-action@v1.0.234", "Claude Code workflow body")
...
`)
	...
	assertContains(t, body, "inference-gateway/infer-action@v0.51.10", "Infer workflow body")
