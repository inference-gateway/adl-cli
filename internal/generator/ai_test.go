...
`)
	...
	assertContains(t, body, "effort:", "Claude Code workflow body")
	...
	assertContains(t, body, "anthropics/claude-code-action@v1.0.235", "Claude Code workflow body")
	...
	assertContains(t, body, "--effort ${{ inputs.effort || 'medium' }}", "Claude Code workflow body")
	assertContains(t, body, "--model ${{ inputs.model || 'claude-opus-5-5' }}", "Claude Code workflow body")
...
`)
	...
	assertContains(t, body, "inference-gateway/infer-action@v0.51.12", "Infer workflow body")
