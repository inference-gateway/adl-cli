...
`)
	...
	assertContains(t, body, "anthropics/claude-code-action@v1.0.224", "Claude Code workflow body")
...
`)
	...
	assertContains(t, body, "inference-gateway/infer-action@v0.51.3", "Infer workflow body")
